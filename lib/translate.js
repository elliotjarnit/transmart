...
async function translate(params, retryTime = 0) {
    const { baseLang, targetLang, openAIApiKey, retryTimes, openAIApiUrl, openAIApiUrlPath, content, openAIApiModel, context, systemPromptTemplate, additionalReqBodyParams, } = params;
    const headers = {
