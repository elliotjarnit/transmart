...
class Task {
    ...
    async run(content, index) {
        const { openAIApiKey, openAIApiUrl, openAIApiUrlPath, openAIApiModel, baseLocale, context, retryTimes, requestsPerMinuteLimit, tokensPerMinuteLimit, systemPromptTemplate, additionalReqBodyParams, } = this.transmart.options;
