...
class Task {
    ...
    async run(content, index) {
        const { openAIApiKey, openAIApiUrl, openAIApiUrlPath, openAIApiModel, baseLocale, context, retryTimes, requestsPerMinuteLimit, systemPromptTemplate, additionalReqBodyParams, } = this.transmart.options;
